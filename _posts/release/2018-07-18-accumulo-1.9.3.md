...
Handle many tablets referencing many WALs [#854] [#860]

Fix improper handling of new WAL failure [#949] [#1005] [#1057]

Fix WAL RecoveryLogReader error on failed file [#961] [#1048]

Fix Unreferenced closed WALs that were never written to [#823] [#845]
