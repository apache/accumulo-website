...
file, cluster.yaml, in the conf directory instead of multiple files (tserver, manager, gc, etc.). The new
file also contains options for starting multiple Tablet and Scan Servers per host.
