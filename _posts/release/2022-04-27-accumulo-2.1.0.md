...
a tserver is recovering, its corresponding row in the Tablet Server Status table will be highlighted and a legend 
will appear to indicate what that color change represents.
...
* {% ghi 2663 %} Highlight rows with recovering tservers in the tserver status table
