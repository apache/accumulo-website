...
{% ghi 6146 %} Added Scan Server property that allows user to control which tables
are allowed to be used with Scan Servers.

{% ghi 5998 %} Added property that allows user to specify whether or not RFiles should
