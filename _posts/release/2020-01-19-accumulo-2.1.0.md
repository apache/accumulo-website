...
{% _docs-2/getting-started/design.md}, {% dlink administration/compaction %} and the
...
* {% ghi 2030 %} {% ghi 2169 %} Cancel compactions when delete table is called
* {% ghi 2182 %} {% ghi 2240 %} Prevent compactions from starting when delete table is called
