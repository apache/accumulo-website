...
* {% ghi 5588 %} and {% ghi 5675 %} together these change make compaction
  planning look ahead more than once to find sets of files to compact that
  would not include smaller sets of files that could compact or are compacting.
